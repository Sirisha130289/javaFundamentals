...
public class Main {
    public static void main(String[] args) {
        ...
        Car car3 = new Car(350, BrandName.PORSCHE, person3, FuelType.GAS, 1150000, 3200);
        Car car4 = new Car(460, BrandName.PEUGOT, person4, FuelType.PETROL, 30000, 2800);
        Car car5 = new Car(220, BrandName.TESLA, person5, FuelType.DIESEL, 250000, 3000);
